...
const config = require(path.join(process.cwd(), "/utils/perf/filesize/filesize.config.js"))

// const config = require(path.join(process.cwd(), "/utils/perf/filesize.config.js"));
